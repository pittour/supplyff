<template>
  <v-container>
    <span class="headline">Privacy Policy
    </span>
    ...
    <p>
      ...
      Supplyff,
      63 rue Paul Verlaine Villeurbanne,
      Rhône
      69100,
      France,
      email: monadressemail69@yahoo.fr,
      phone: 0600000000

      on the collection,
      use and disclosure of your information that we collect
      when you use our website ( https://www.supplyff.fr ).
    ...
    <ol>
      ...
      <li>
        ...
        <p>
          ...
          We do not store any sensitive information and only necessary cookies are used in order to run the website.
        </p>
      </li>
